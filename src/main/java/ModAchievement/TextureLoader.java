...
public class TextureLoader {
    ...
    public static Texture getTextureOrNull(final String textureString) {
        if (textures.get(textureString) == null) {
            try {
                loadTexture(textureString);
            } catch (GdxRuntimeException e) {
    ...
    public static TextureRegion getTextureRegionOrNull(final String textureString) {
        if (textures.get(textureString) == null) {
            try {
                loadTexture(textureString);
            } catch (GdxRuntimeException e) {
        ...
        return new TextureRegion(textures.get(textureString));
    }
